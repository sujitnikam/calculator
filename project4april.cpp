...
//graph ends
        ...
        if(isthere(x,y,875,380,210,100))//for =
        {
            ...
            p[1]=postexpr[1];
            int a=1;
            for(int k=0; k<1/*postexpr.size()*/; k++) //display entire expression
            {
                if(!isNumeric(p[k]) || !isNumeric(p[k+1]))
                {
                    /* a=0;cout<<"aa";
                     string_no="Syntax Error";
                     */
                }
                //cout<<postexpr[k]<<endl;
            }
    ...
    /* for(int k=0;k<str.size();k++) //display entire expression
     {
     cout<<str[k]<<endl;
     }
     for(int k=0;k<postexpr.size();k++) //display entire expression
     {
     cout<<postexpr[k]<<endl;
     }*/
